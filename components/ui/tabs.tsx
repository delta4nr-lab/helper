...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-primary/5 ring-1 ring-border/60",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        // Лише активний ТЕКСТ default-варіанта — синій (фон лишаємо нейтральним).
        "group-data-[variant=default]/tabs-list:cursor-pointer group-data-[variant=default]/tabs-list:data-active:text-blue-500 dark:group-data-[variant=default]/tabs-list:data-active:text-blue-400",
