...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly MedicalReferral: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly courseRecordId: CodecTypes['pg/text@1']['output'];
      readonly facility: CodecTypes['pg/text@1']['output'] | null;
      readonly referralDate: CodecTypes['pg/text@1']['output'] | null;
      readonly createdAt: TimestampString<3>;
      readonly updatedAt: TimestampString<3>;
    };
    readonly Personnel: {
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly MedicalReferral: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly courseRecordId: CodecTypes['pg/text@1']['input'];
      readonly facility: CodecTypes['pg/text@1']['input'] | null;
      readonly referralDate: CodecTypes['pg/text@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamp-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamp-string@1']['input'];
    };
    readonly Personnel: {
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly MedicalReferral: {
              ...
              primaryKey: {
                readonly columns: readonly ['id'];
                readonly name: 'MedicalReferral_pkey';
              };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'MedicalReferral_courseRecordId_idx';
                  readonly columns: readonly ['courseRecordId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'MedicalReferral';
                    readonly columns: readonly ['courseRecordId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                  ...
                  readonly name: 'MedicalReferral_courseRecordId_fkey';
                },
              ];
            };
            readonly Personnel: {
...
> & {
  ...
  readonly roots: {
    ...
    readonly MedicalReferral: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'MedicalReferral';
    };
          ...
          readonly CourseRecord: {
            ...
            readonly relations: {
              ...
              readonly medicalReferrals: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['courseRecordId'];
                };
              };
            };
            readonly storage: {
          ...
          readonly MedicalReferral: {
            ...
            readonly relations: {
              readonly courseRecord: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['courseRecordId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              readonly table: 'MedicalReferral';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly courseRecordId: { readonly column: 'courseRecordId' };
                readonly facility: { readonly column: 'facility' };
                readonly referralDate: { readonly column: 'referralDate' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
