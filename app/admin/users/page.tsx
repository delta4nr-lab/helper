...
export default async function AdminUsersPage() {
  const users = await prisma.user.findMany({ select: { id: true, username: true, role: true, isActive: true, profile: { select: { lastName: true, firstName: true, rank: true } }, _count: { select: { exports: true } } }, orderBy: { createdAt: "desc" }, take: 100 })
